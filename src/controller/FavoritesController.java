...
/**
 * This class is the controller of the Favorites view This view represents the
 * list of favorites recipes for the used logged in
 * 
...
public class FavoritesController implements Initializable {
	...
	/**
	 * The list of favorites recipes of the user logged in
	 */
	private ArrayList<Recipe> favorites = User.getSession().getFavoriteList();
	
	/**
	 * The list of favorite recipes to add in the table view
	 */
	 ...
	 * favorites. This methods changes the user's favorites list to an
	...
	/**
	 * When the user clicks on the button that allows him to remove a recipe from
	 * his/her favorites, this method is called. This method removes the recipe from
	 * the favorites list of the user, print the changes on the screen and a
	 * confirmation
	 * 
	 * @param event
	 * @see #getRecipes()
	...
	/**
	 * This method is called when the user clicks on a recipe in the tab. This
	 * method loads the view of the recipe, where I can have all the information of
	 * the recipe.
	 * 
	 * @param event
	 */
